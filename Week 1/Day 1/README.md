# 📅 Week 1 — Day 1: SQL Foundations

> **Focus:** Building a strong foundation in SQL, exploring queries, string matching, dates, and group-by clauses.
...
| File | Description |
|------|-------------|
| [practice_queries.txt](practice_queries.txt) | All 30 SQL queries practice questions |
| [solution_queries.sql](solution_queries.sql) | All 30 SQL queries practice solutions |
| [README.md](README.md) | Summary of Day 1 learnings |
